...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _downloadFile(String taskId) async {
    try {
      ...
      await NotificationService.show('Download concluído', 'Arquivo salvo em ${outFile.path}');
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 16),
              Text('Token: ${_accessToken.isNotEmpty ? _accessToken : 'não logado'}'),
              const SizedBox(height: 12),
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        title: Text(item['title'] ?? item['url'] ?? 'Sem título'),
