            ...
            child: Column(
                ...
                if (_isLoggedIn) ...[
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      final t = await _api.download(url, _downloadMode, _downloadFormat, _downloadQuality, _downloadQuality);
                      _taskId.text = t;
              ...
              if (_isLoggedIn) ...[
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (v) {
                    if (v != null) {
                      setState(() {
                        _downloadMode = v;
                        _downloadFormat = v == 'audio' ? 'mp3' : 'mp4';
                        _downloadQuality = v == 'audio' ? '192k' : '720p';
                      });
                    }
                  },
                  decoration: const InputDecoration(
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (v) {
                    if (v != null) setState(() => _downloadFormat = v);
                  },
                  decoration: const InputDecoration(
                    labelText: 'Formato',
                    border: OutlineInputBorder(),
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (v) {
                    if (v != null) setState(() => _downloadQuality = v);
                  },
                  decoration: const InputDecoration(
                    labelText: 'Qualidade',
                    border: OutlineInputBorder(),
