...
def create_icon(size: int, output_path: str):
    ...
    draw.rectangle(
        [center - rect_width/2, center - arrow_height/2,
         center + rect_width/2, center + rect_height/3],
        fill=white
    )
    ...
    draw.rectangle(
        [center - line_width/2, line_y,
         center + line_width/2, line_y + arrow_height * 0.1],
        fill=white
    )
...
def create_presplash(width: int, height: int, output_path: str):
    ...
    draw.rectangle(
        [center_x - 15, center_y - arrow_size * 0.8,
    ...
    draw.text(
        (center_x - text_width // 2, center_y + 120),
        text,
        fill=white,
        font=font_large
    )
    ...
    draw.text(
        (center_x - text2_width // 2, center_y + 190),
        text2,
        fill=accent_color,
        font=font_small
    )
