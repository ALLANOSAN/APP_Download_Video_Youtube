...
try:
    ...
    from .styles import MAIN_STYLE, MODAL_STYLE, COLORS, SIZES
    ...
    from utils.settings import get_settings
    from utils.logger import get_logger
    from gui.styles import MAIN_STYLE, MODAL_STYLE, COLORS, SIZES
    from gui.components import SkeletonCard
