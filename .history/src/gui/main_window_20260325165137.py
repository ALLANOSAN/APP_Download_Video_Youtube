...
try:
    ...
    from downloader.video_downloader import (  # type: ignore[import-not-found]
        VideoDownloader,
        AUDIO_FORMATS,
        AUDIO_QUALITIES,
        VIDEO_QUALITIES,
    )
    from utils.settings import get_settings  # type: ignore[import-not-found]
    from utils.logger import get_logger  # type: ignore[import-not-found]
    from gui.styles import MAIN_STYLE, MODAL_STYLE, COLORS, SIZES  # type: ignore[import-not-found]
    from gui.components import SkeletonCard  # type: ignore[import-not-found]
