...
class VideoDownloader:
    def __init__(
        ...
        # Define caminhos dos binários
        base_path = get_base_path()
        self.ffmpeg_path = base_path / "binaries" / get_binary_name("ffmpeg")
        self.ytdlp_path = base_path / "binaries" / get_binary_name("yt-dlp")
    ...
    def download_video(
        ...
        Args:
            ...
            video_quality: Qualidade do vídeo (360p, 720p, 1080p, etc.)
        """
        if self._stop_event.is_set():
            return False, "Cancelado", None

        self.logger.info(f"Iniciando download de vídeo: {url}")
        self.logger.info(f"Qualidade: {video_quality}")
        ...
        format_spec = quality_map.get(video_quality, "bestvideo+bestaudio/best")
