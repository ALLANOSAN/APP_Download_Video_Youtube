...
class VideoDownloader:
    ...
    def download_video(
        ...
        if requested_quality in fallback_order:
            start_index = fallback_order.index(requested_quality)
            candidates = [requested_quality] + [q for q in fallback_order if q != requested_quality and fallback_order.index(q) >= start_index]
        else:
